...
type
  TfrmMain = class(TForm)
    ...
    procedure mnuTabeehCounter1Click(Sender: TObject);
    procedure DuaforToday1Click(Sender: TObject);
...
uses UnitZikerMethod, UnitTabeehCounter, UnitDailyDua;
...
procedure TfrmMain.mnuTabeehCounter1Click(Sender: TObject);
begin
  frmTasbeehCounter.ShowModal;
end;
...
procedure TfrmMain.DuaforToday1Click(Sender: TObject);
begin
  frmDailydua.ShowModal;
end;
...
begin
  ...
  if txtFullName.Text = '' then
    begin
       MessageDlg('Enter ''Full Name'' and try again.', mtInformation, [mbOK], 0);
       exit;
    end;
